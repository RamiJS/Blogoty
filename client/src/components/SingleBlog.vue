<template>
        <router-link @click="sendParam" :to="{ name: 'blog', params: { id: blog._id } }" class="flex flex-col md:flex-row gap-5 md:gap-2 my-6 lg:gap-8 shadow-md">
            ...
            <div class="flex flex-col gap-2 md:gap-3 px-3 py-3 my-auto">
                ...
                <p class="text-xs text-black-100/70 md:text-base">{{blog.brief}}</p>
